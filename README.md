...
_A simple Discord bot to automate conversations with predefined dialogs, dynamic replies, and manual message cancellation support._  
...
token_name:token:min_interval:max_interval
...
Set the start time in minutes (0 for immediate start).

Specify the number of delays (e.g., 1).

Input delay details (e.g., 2 messages, 30 seconds).

Choose whether to change intervals after delays (y/n).


4️⃣ Monitor Terminal
